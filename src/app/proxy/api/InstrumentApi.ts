...
export class InstrumentApi {
     ...
     */
    public getInstruments(title?: string, extraHttpRequestParams?: any): Observable<Array<models.Instrument>> {
        return this.getInstrumentsWithHttpInfo(title, extraHttpRequestParams)
     ...
     * @param title The title of a specific instrument
     */
    public getInstrumentsWithHttpInfo(title?: string, extraHttpRequestParams?: any): Observable<Response> {
