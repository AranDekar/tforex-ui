...
export class DefaultApi {
     ...
     */
    public hello(name?: string, extraHttpRequestParams?: any): Observable<models.HelloWorldResponse> {
        return this.helloWithHttpInfo(name, extraHttpRequestParams)
     ...
     * @param name The name of the person to whom to say hello
     */
    public helloWithHttpInfo(name?: string, extraHttpRequestParams?: any): Observable<Response> {
